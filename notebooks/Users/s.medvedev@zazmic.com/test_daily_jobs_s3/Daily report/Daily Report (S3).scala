...
val mxRawRdd = conxDF
  .select("ap", "at", "av", "xp", "ma", "dt", "ca", "pl")
  .map {row =>
    ...
    (ap, at, av, xp, ma, new Timestamp(dayTimestamp.getMillis), ca, pl)
  }
  .toDF("ap", "at", "av", "xp", "ma", "dt", "ca", "pl")
...
val mxRawRdd = conxDF
  ...
  .map {row =>
    ...
    (ap, at, av, xp, ma, new Timestamp(dayTimestamp.getMillis), pl)
  }
  .toDF("ap", "at", "av", "xp", "ma", "dt","pl")
...
//     var dayTimestamp = new DateTime(utcActionTimestamp)
//     dayTimestamp = new DateTime(dayTimestamp.getYear, dayTimestamp.getMonthOfYear, dayTimestamp.getDayOfMonth, 0, 0)
//     (ap, at, av, xp, ma, new Timestamp(dayTimestamp.getMillis))
//   }
//   .toDF("ap", "at", "av", "xp", "ma", "dt")
//   .distinct
//   .rdd 

val currentTs = new Timestamp(DateTime.now().getMillis)

val appDeliveryDFRaw = mxRdd.map { row =>
    val ap = row.getString(0)
    val at = row.getString(1)
    val av =  extractNullableString(row, 2)
    val dt = row.getTimestamp(5)
...
val mxRawRdd = conxDF
  ...
  .map {row =>
    ...
    (ap, at, av, xp, ma, new Timestamp(dayTimestamp.getMillis), tr)
  }
  .toDF("ap", "at", "av", "xp", "ma", "dt", "tr")
...
val compTriggerPerfDFRaw = mxRdd.map { row =>
    val ap = row.getString(0)
    val at = row.getString(1)
    val av =  extractNullableString(row, 2)
    val dt = row.getTimestamp(5)
...
val triggerPerfDFRaw = mxRdd.map { row =>
    val ap = row.getString(0)
    val at = row.getString(1)
    val av =  extractNullableString(row, 2)
    val xp = row.getString(3)
...
//     var dayTimestamp = new DateTime(utcActionTimestamp)
//     dayTimestamp = new DateTime(dayTimestamp.getYear, dayTimestamp.getMonthOfYear, dayTimestamp.getDayOfMonth, 0, 0)
//     val ca = if (!row.isNullAt(6)) row.getString(6) else null
//     (ap, at, av, xp, ma, new Timestamp(dayTimestamp.getMillis), ca)
//   }
//   .toDF("ap", "at", "av", "xp", "ma", "dt", "ca")
//   .distinct
//   .rdd 

val currentTs = new Timestamp(DateTime.now().getMillis)

val campDeliveryDFRaw = mxRdd.map { row =>
    val ap = row.getString(0)
    val at = row.getString(1)
    val av =  extractNullableString(row, 2)
    val xp = row.getString(3)
...
val contentDeliveryDFRaw = mxRdd.map { row =>
    val ap = row.getString(0)
    val at = row.getString(1)
    val av =  extractNullableString(row, 2)
    val xp = row.getString(3)
