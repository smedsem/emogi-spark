...
dayRanges.foreach { day =>
  ...
  val result = dbutils.notebook.run("/Users/alex@emogi.com/daily_jobs_s3/ODS_ETL/ODS ETL (S3)", timeoutSec, Map("dateFrom" -> day._1.toString, "dateTo" -> day._2.toString, "s3Folder" -> s3Folder))
