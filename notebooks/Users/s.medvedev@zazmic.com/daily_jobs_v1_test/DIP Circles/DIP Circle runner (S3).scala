...
dayRanges.foreach { day =>
  ...
  val result = dbutils.notebook.run("/Users/alex@emogi.com/daily_jobs_s3/DIP Circles/DIP Circle data (S3)", timeoutSec, Map("dateFrom" -> day._1.toString, "dateTo" -> day._2.toString))
